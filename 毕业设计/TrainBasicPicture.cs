...
namespace 毕业设计
{
    ...
    class TrainBasicPicture
    {
       ...
       public Bitmap DrawTrainBasicPicture(Scale scale)
       {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<PointF> GetHourLinePoints(float width,float height,int step,out List<PointF> tableLineEndPoints)
        {
        ...
        /// </summary>
        /// <returns></returns>
        IEnumerable<PointF> GetLineMinutesPoints(int hourTime, int step,out List<PointF> lineMinutesEndPoints)
        {
